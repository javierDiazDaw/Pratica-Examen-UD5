...
public class Ud5Ejercicio1 {
	...
	public static void main(String[] args) {
		float[][] datosBolas = { { 5f, 5f }, { 5.1f, 5.1f }, { 4.9f, 4.9f }, { 5.1f, 5.15f }, { 5.1f, 5.05f },
				{ 5f, 5f }, { 5f, 5f }, { 3f, 1f }, { 4.95f, 2.5f }, { 4.9f, 4.9f }, { 8f, 8f }, { 3f, 2f } };
	...
	/**
	 * El método debe crear un nuevo Array de Bolas usando los datos que se pasan
	 * como parametro.
	 * 
	 * @param datosBolas datos de las bolas en array bidimensional de numero de
	 *                   filas variable y longitud de columnas = 2
	...
	public static Bola[] crearBolas(float[][] datosBolas) {
		...
		/**
		 * for (int j = 0; j < datosBolas.length; j++) { retorno[i] = new
		 * Bola(datosBolas[1][0], fs[1][0]); i++; }
		 */
	 ...
	 * 
	 * Hay que imprimir una linea con la informacion que la bola proporciona de
	 * forma predeterminada en su metodo toString
	 * 
	 ...
	 * 
	 * Debe devolver un nuevo arrar mas pequeño que se ajuste perfectamente a los
	 * elementos que quedan tras la eliminacion
	 * 
	 * RECUERDA QUE EL METODO TRABAJA SOBRE UNA COPIA NO DEBE MODIFICAR EL ARRAY
